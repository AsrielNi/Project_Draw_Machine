...
class ITabPage(ABC):
    @abstractmethod
    def __init__(self, page_name: str, attach_manager: TabPageManager | None = None):
...
class TabPageManager():
    def __init__(self, title_name: str = "NoName", init_window_size: str = "800x600+50+50"):
        ...
        self.__select_color = "#90FFE5"
        self.__unselect_color = "#C5F6EB"
    def layout(self):
    ...
    def _remove_tab_page(self, page_name: str):
        if self._tab_pages.get(page_name) == None:
            ...
            self._auto_build_tab_buttons()
    def _auto_build_tab_buttons(self):
    ...
    def __command_create_tab_page(self):
    ...
    def __command_change_page(self, tab_page: ITabPage):
...
class CreateTabPage:
    def __init__(self, parent_manager: TabPageManager, title_name: str = "創建分頁", window_size: str = "300x200+100+100"):
